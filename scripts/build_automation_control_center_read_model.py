...
JOB_META: dict[str, dict[str, Any]] = {
    ...
    "com.youngkwon.secondbrain.nightly-capture-batch": {"pipelineId": "memory_capture", "stage": "capture", "ssot": "second-brain", "costClass": "medium", "disableSafe": False, "optional": False},
