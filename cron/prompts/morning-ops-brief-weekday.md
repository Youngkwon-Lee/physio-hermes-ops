...
- Do not include `/home/yk/`, `/tmp/`, manifest paths, the words `Manifest`/`manifest`/`매니페스트`, `status ok`, `Record: manifest created`, or similar internal run artifacts in the final response.
